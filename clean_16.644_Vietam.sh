...
rm -rf /storage/emulated/0/Android/data/com.vng.pubgmobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/AntiCheat.ini_
rm -rf /storage/emulated/0/Android/data/com.vng.pubgmobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Config/Android/EditorPerProjectUserSettings.ini_
...
rm -rf /data/user/0/com.vng.pubgmobile/app_bugly
rm -rf /data/user/0/com.vng.pubgmobile/app_crashrecord
rm -rf /data/user/0/com.vng.pubgmobile/code_cache
rm -rf /data/user/0/com.vng.pubgmobile/no_backup
...
rm -rf /data/user/0/com.vng.pubgmobile/databases/DownloadsDB-shm
...
rm -rf /data/user/0/com.vng.pubgmobile/databases/DownloadsDB-wal
