...
sleep 2
echo "Ｒｅｍｏｖｅ Ａｎｔｉ Ｃｈｅａｔ．．"
echo "Ｒｅｍｏｖｅ Ｄａｔａｂａｓｅ Ｆｉｌｅ ．．．"
...
rm -rf /data/user/0/com.tencent.ig/app_bugly
rm -rf /data/user/0/com.tencent.ig/app_crashrecord
...
rm -rf /data/user/0/com.tencent.ig/databases/DownloadsDB-shm
...
rm -rf /data/user/0/com.tencent.ig/databases/DownloadsDB-wal
